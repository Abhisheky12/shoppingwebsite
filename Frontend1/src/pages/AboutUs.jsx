        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
              Founded in 2025, ShopEasy was born from a simple idea: to make online shopping a seamless and enjoyable experience. We believe that finding high-quality products shouldn't be a chore, but a delight.
            </p>
          </div>
